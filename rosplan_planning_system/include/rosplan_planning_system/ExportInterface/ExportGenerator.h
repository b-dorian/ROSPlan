/**
 * This class is responsible for exporting the PDDL instance.
...
#ifndef KCL_ExportGenerator
#define KCL_ExportGenerator
...
namespace KCL_rosplan {
	...
	public:
		...
		void generateCSVFile(std::string &problemPath);
